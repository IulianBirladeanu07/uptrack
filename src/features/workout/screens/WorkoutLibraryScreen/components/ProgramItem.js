        ...
        <View style={[styles.workoutCard, isActive && styles.activeCard]}>
            ...
            <View style={styles.workoutCardHeader}>
                ...
                <View style={styles.workoutMetrics}>
                    ...
                    <View style={styles.metricItem}>
                        <Ionicons name="fitness" size={normalize(fontSize[16])} color={colors.text.secondary} />
                        <Text style={styles.metricText}>{totalExercises} exercises</Text>
                    </View>
                    <View style={styles.metricItem}>
                        <Ionicons name="time-outline" size={normalize(fontSize[16])} color={colors.text.secondary} />
